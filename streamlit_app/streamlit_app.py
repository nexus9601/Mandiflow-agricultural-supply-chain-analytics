...
from src.pages import overview, mandi_analysis, crop_price, transport, weather, data_quality
...
""",
    ...
    page = st.radio(
        "Page",
        options=["Overview", "Mandi Analysis", "Crop & Price", "Transport", "Weather Impact", "Data Quality"],
...
def _show_page(page_name: str) -> None:
    if filtered_df.empty and page_name not in ("Data Quality", "Transport", "Weather Impact"):
        st.markdown(
